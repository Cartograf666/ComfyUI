    ...
    def define_schema(cls):
        return IO.Schema(
            ...
            inputs=[
                ...
                IO.Combo.Input("model", options=["gpt-image-2", "gpt-image-2-edit", "black-forest-labs/flux-1-schnell", "black-forest-labs/flux-1-dev", "black-forest-labs/flux-1-pro"], default="gpt-image-2"),
                IO.Combo.Input("resolution", options=["1K", "2K", "4K", "512x512", "768x768", "1024x1024", "720x1280", "1280x720", "1080x1920", "1920x1080", "auto"], default="1K"),
                IO.Combo.Input("aspect_ratio", options=["1:1", "16:9", "9:16", "4:3", "3:4", "21:9", "auto"], default="9:16"),
                IO.Combo.Input("quality", options=["low", "medium", "high", "standard", "hd"], default="low"),
                IO.Int.Input("seed", default=0, min=0, max=2147483647, control_after_generate=True),
                IO.Float.Input("image_prompt_strength", default=0.1, min=0.0, max=1.0, step=0.01),
    ...
    def define_schema(cls):
        return IO.Schema(
            ...
            inputs=[
                IO.String.Input("prompt", multiline=True, default=""),
                IO.Combo.Input("api_provider", options=["poyo", "atlascloud"], default="poyo"),
                IO.String.Input("model", default="seedance-2"),
                IO.Combo.Input("resolution", options=["480p", "720p", "1080p", "4k"], default="720p"),
                IO.Combo.Input("aspect_ratio", options=["16:9", "9:16", "1:1", "4:3", "3:4", "21:9", "auto"], default="9:16"),
                IO.Int.Input("duration", default=6, min=4, max=15, step=1),
